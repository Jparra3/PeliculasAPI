...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class ActoresControllerTest: BasePruebas
    {
        ...
        public async Task ObtenerPersonasPaginadas()
        {
            ...
            //se agrega un httpcontext para el tema del paginado
        ...
        public async Task CrearActorSinFoto()
        {
            ...
            var actor = new ActorCreateDto() { Nombre = "Juan", FechaNacimiento = DateTime.Now };

            var mock = new Mock<IAlmacenarArchivos>();
        ...
        public async Task PatchActualizaUnSoloCampo()
        {
            ...
            //Se está aciendo que cuando se mande con cualquier valor pasaro en los parametros, queremos que se aprueba
            ...
            patchDocument.Operations.Add(new Operation<ActorPatchDto>("replace", "/nombre", null, "Jhonatan"));
            ...
            Assert.AreEqual("Jhonatan", actorDb.Nombre);
